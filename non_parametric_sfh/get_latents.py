...
#load data
print('Loading data')
#percentiles=np.load('./input/percent_150_non_par.npy')
#wave=np.load('./input/wave_150_non_par.npy')
#seds=np.load('./input/seds_150_non_par.npy')

percentiles=np.load('./percent_150_non_par.npy')
wave=np.load('./wave_150_non_par.npy')
seds=np.load('./seds_150_non_par.npy')
...
np.save("./output_spender/150_y_test_pred_"+str(n)+".npy",ys_)
np.save('./output_spender/150_latents.npy',ss)
np.save("./output_spender/150_percentiles.npy",percentiles)
