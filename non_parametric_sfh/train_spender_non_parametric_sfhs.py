...
print("cuda:0" if use_cuda else "cpu",' prepared')
...
y_train = percentiles[:int(0.8*l),:] #percentiles

x_val = seds[int(0.8*l):int(0.9*l),:] #seds
y_val = percentiles[int(0.8*l):int(0.9*l),:] #percentiles
