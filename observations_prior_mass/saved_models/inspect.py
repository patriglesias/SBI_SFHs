...
losses=np.loadtxt('./losses_m14.txt')
...
percent_pred=np.load('./y_test_pred_m14.npy',allow_pickle=True)
latents=np.load('./latents_m14.npy',allow_pickle=True)
percent=np.load('./y_test_m14.npy',allow_pickle=True)
