...
seds=np.load('../../seds_large/obs/seds_m14.npy')
y=np.load('./saved_input/y_m14.npy')

print('Shuffling...')

ind_sh=np.load('./saved_models/ind_sh_m14.npy')
...
print('Loading model...')
model_file = "./saved_models/checkpoint_m14.pt"
...
np.save("./saved_models/y_test_pred_m14.npy",ys_)#y_.cpu())
np.save('./saved_models/latents_m14.npy',ss) #s.cpu())
np.save('./saved_models/y_test_m14.npy', percentiles) #,percent.cpu())
