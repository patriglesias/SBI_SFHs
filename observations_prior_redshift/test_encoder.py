...
seds=np.load('../../seds_large/obs/seds_m14_z20.npy')
y=np.load('./saved_input/y_m14_z20.npy')

print('Shuffling...')

ind_sh=np.load('./saved_models/ind_sh_m14_z20.npy')
...
print('Loading model...')
model_file = "./saved_models/checkpoint_m14_z20.pt"
...
np.save("./saved_models/y_test_pred_m14_z20.npy",ys_)#y_.cpu())
np.save('./saved_models/latents_m14_z20.npy',ss) #s.cpu())
np.save('./saved_models/y_test_m14_z20.npy', percentiles) #,percent.cpu())
